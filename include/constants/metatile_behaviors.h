...
#define MB_MOUNTAIN_TERRAIN 0x54
...
#define MB_UP_RIGHT_STAIR_WARP 0xD7
#define MB_UP_LEFT_STAIR_WARP 0xD8
#define MB_DOWN_RIGHT_STAIR_WARP 0xD9
#define MB_DOWN_LEFT_STAIR_WARP 0xDA
