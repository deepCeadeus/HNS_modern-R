...
- Restored missing options in the Options Menu, from Modern Emerald 3.5
    - Difficulty option
    - Bike Music option
    - Surf Music option
...
- Restored missing options in the Challenges Menu, from Modern Emerald 3.5
...
- Shiny Pokémon can be seen in the Pokédex.
- Followers can be selected regardless their party position.
- Rare candies can be used to evolve Pokémon at their max level or at the level cap.
...
- devkitARM version 65 or older is required (newest versions should work, but not guaranteed)
