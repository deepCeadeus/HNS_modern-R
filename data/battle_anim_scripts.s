...
gBattleAnims_Moves::
	...
	.4byte Move_SABLEYE_RECOVER
	.4byte Move_SABLEYE_WILL_O_WISP
	.4byte Move_SABLEYE_TAUNT
	.4byte Move_SABLEYE_TORMENT
...
Move_TWIN_BEAM:
	...
	call HyperBeamOrbs
	createvisualtask AnimTask_ShakeMon2, 2, ANIM_TARGET, 4, 0, 50, 1
	createvisualtask AnimTask_BlendBattleAnimPal, 10, F_PAL_TARGET, 2, 0, 11, RGB_WHITE
	call HyperBeamOrbs
	call HyperBeamOrbs
	call HyperBeamOrbs
	call HyperBeamOrbs
	...
	call HyperBeamOrbs
	call HyperBeamOrbs
	createvisualtask AnimTask_BlendBattleAnimPal, 10, F_PAL_TARGET, 2, 11, 0, RGB_WHITE
	waitforvisualfinish
	//call UnsetPsychicBackground
	end
...
Move_HYPER_DRILL:
	...
	createsprite gBowMonSpriteTemplate, ANIM_ATTACKER, 2, 1
	delay 2
	loopsewithpan SE_M_ROCK_THROW, SOUND_PAN_TARGET, 4, 8
	createvisualtask AnimTask_DrillPeckHitSplats, 5
	createvisualtask AnimTask_BlendMonInAndOut, 10, ANIM_TARGET, RGB_RED, 10, 1, 1
	createvisualtask AnimTask_ShakeMon2, 2, ANIM_TARGET, 4, 0, 18, 1
	waitforvisualfinish
	createsprite gBowMonSpriteTemplate, ANIM_ATTACKER, 2, 2
	waitforvisualfinish
...
Move_JUDGMENT:
	...
	createsprite gHiddenPowerOrbSpriteTemplate, ANIM_ATTACKER, 2, 26, 168
	createsprite gHiddenPowerOrbSpriteTemplate, ANIM_ATTACKER, 2, 26, 210
	//createvisualtask AnimTask_InvertScreenColor, 10, 257, 257, 257
	delay 52
	setarg 7, 0xFFFF
	createvisualtask SoundTask_PlayCryHighPitch, 2, ANIM_ATTACKER, 3
	createvisualtask AnimTask_InvertScreenColor, 20, 257, 257, 257
	delay 30
	createvisualtask AnimTask_ScaleMonAndRestore, 5, -7, -7, 11, ANIM_ATTACKER, 0
	//createvisualtask AnimTask_InvertScreenColor, 15, 257, 257, 257
	createsprite gHiddenPowerOrbScatterSpriteTemplate, ANIM_TARGET, 2, 0
	createsprite gHiddenPowerOrbScatterSpriteTemplate, ANIM_TARGET, 2, 32
	createsprite gHiddenPowerOrbScatterSpriteTemplate, ANIM_TARGET, 2, 64
	createsprite gHiddenPowerOrbScatterSpriteTemplate, ANIM_TARGET, 2, 96
