...
{
    //Normal Trainer rematches, HnS version
    [REMATCH_JOEY] = REMATCH(TRAINER_JOEY, TRAINER_JOEY_2, TRAINER_JOEY_3, TRAINER_JOEY_4, TRAINER_JOEY_5, ROUTE30),//Hns Rematch
    [REMATCH_MIKEY] = REMATCH(TRAINER_MIKEY, TRAINER_MIKEY_2, TRAINER_MIKEY_3, TRAINER_MIKEY_4, TRAINER_MIKEY_5, ROUTE30),//Hns Rematch
    [REMATCH_LIZ] = REMATCH(TRAINER_LIZ, TRAINER_LIZ_2, TRAINER_LIZ_3, TRAINER_LIZ_4, TRAINER_LIZ_5, ROUTE32),//Hns Rematch
    [REMATCH_COLETTE] = REMATCH(TRAINER_COLETTE, TRAINER_COLETTE_2, TRAINER_COLETTE_3, TRAINER_COLETTE_4, TRAINER_COLETTE_5, ROUTE15), //Hns Rematch
    [REMATCH_BROOKE] = REMATCH(TRAINER_BROOKE, TRAINER_BROOKE_2, TRAINER_BROOKE_3, TRAINER_BROOKE_4, TRAINER_BROOKE_5, ROUTE35),//Hns Rematch
    [REMATCH_HENRY] = REMATCH(TRAINER_HENRY, TRAINER_HENRY_2, TRAINER_HENRY_3, TRAINER_HENRY_4, TRAINER_HENRY_5, ROUTE32),//Hns Rematch
    [REMATCH_ANTHONY] = REMATCH(TRAINER_ANTHONY, TRAINER_ANTHONY_2, TRAINER_ANTHONY_3, TRAINER_ANTHONY_4, TRAINER_ANTHONY_5, ROUTE33),//Hns Rematch
    [REMATCH_BETH] = REMATCH(TRAINER_BETH, TRAINER_BETH_2, TRAINER_BETH_3, TRAINER_BETH_4, TRAINER_BETH_5, ROUTE26NORTH), //Hns Rematch
    [REMATCH_BRANDON] = REMATCH(TRAINER_BRANDON, TRAINER_BRANDON_2, TRAINER_BRANDON_3, TRAINER_BRANDON_4, TRAINER_BRANDON_5, ROUTE34),//Hns Rematch
    [REMATCH_TOBY] = REMATCH(TRAINER_TOBY, TRAINER_TOBY_2, TRAINER_TOBY_3, TRAINER_TOBY_4, TRAINER_TOBY_5, ROUTE38),//Hns Rematch
    [REMATCH_JOE] = REMATCH(TRAINER_JOE, TRAINER_JOE_2, TRAINER_JOE_3, TRAINER_JOE_4, TRAINER_JOE_5, ROUTE25), //Hns Rematch
    [REMATCH_ROY] = REMATCH(TRAINER_ROY, TRAINER_ROY_2, TRAINER_ROY_3, TRAINER_ROY_4, TRAINER_ROY_5, ROUTE14), //Hns Rematch
    [REMATCH_JAMIE] = REMATCH(TRAINER_JAMIE, TRAINER_JAMIE_2, TRAINER_JAMIE_3, TRAINER_JAMIE_4, TRAINER_JAMIE_5, ROUTE39), //Hns Rematch
    [REMATCH_ANN_AND_ANNE] = REMATCH(TRAINER_ANN_AND_ANNE, TRAINER_ANN_AND_ANNE_2, TRAINER_ANN_AND_ANNE_3, TRAINER_ANN_AND_ANNE_4, TRAINER_ANN_AND_ANNE_5, ROUTE37),//Hns Rematch
    [REMATCH_SIMON] = REMATCH(TRAINER_SIMON, TRAINER_SIMON_2, TRAINER_SIMON_3, TRAINER_SIMON_4, TRAINER_SIMON_5, ROUTE40), //Hns Rematch
    [REMATCH_SHANE] = REMATCH(TRAINER_SHANE, TRAINER_SHANE_2, TRAINER_SHANE_3, TRAINER_SHANE_4, TRAINER_SHANE_5, ROUTE42), //Hns Rematch
    [REMATCH_RON] = REMATCH(TRAINER_RON, TRAINER_RON_2, TRAINER_RON_3, TRAINER_RON_4, TRAINER_RON_5, ROUTE43), //Hns Rematch
    [REMATCH_ELLIOT] = REMATCH(TRAINER_ELLIOT, TRAINER_ELLIOT_2, TRAINER_ELLIOT_3, TRAINER_ELLIOT_4, TRAINER_ELLIOT_5, ROUTE35),//Hns Rematch    
    [REMATCH_PHIL] = REMATCH(TRAINER_PHIL, TRAINER_PHIL_2, TRAINER_PHIL_3, TRAINER_PHIL_4, TRAINER_PHIL_5, ROUTE44), //Hns Rematch  
    [REMATCH_KELLY] = REMATCH(TRAINER_KELLY, TRAINER_KELLY_2, TRAINER_KELLY_3, TRAINER_KELLY_4, TRAINER_KELLY_5, ROUTE45),//Hns Rematch
    [REMATCH_BRENT] = REMATCH(TRAINER_BRENT, TRAINER_BRENT_2, TRAINER_BRENT_3, TRAINER_BRENT_4, TRAINER_BRENT_5, ROUTE43),//Hns Rematch
    [REMATCH_BOB] = REMATCH(TRAINER_BOB, TRAINER_BOB_2, TRAINER_BOB_3, TRAINER_BOB_4, TRAINER_BOB_5, ROUTE18), //Hns Rematch
    [REMATCH_THOM_AND_KAE] = REMATCH(TRAINER_THOM_AND_KAE, TRAINER_THOM_AND_KAE_2, TRAINER_THOM_AND_KAE_3, TRAINER_THOM_AND_KAE_4, TRAINER_THOM_AND_KAE_5, ROUTE47), //Hns Rematch
    [REMATCH_QUINN] = REMATCH(TRAINER_QUINN, TRAINER_QUINN_2, TRAINER_QUINN_3, TRAINER_QUINN_4, TRAINER_QUINN_5, ROUTE1), //Hns Rematch
    [REMATCH_WARREN] = REMATCH(TRAINER_WARREN, TRAINER_WARREN_2, TRAINER_WARREN_3, TRAINER_WARREN_4, TRAINER_WARREN_5, ROUTE3), //Hns Rematch
    [REMATCH_ALLAN] = REMATCH(TRAINER_ALLAN, TRAINER_ALLAN_2, TRAINER_ALLAN_3, TRAINER_ALLAN_4, TRAINER_ALLAN_5, ROUTE6), //Hns Rematch
    [REMATCH_ZEKE] = REMATCH(TRAINER_ZEKE, TRAINER_ZEKE_2, TRAINER_ZEKE_3, TRAINER_ZEKE_4, TRAINER_ZEKE_5, ROUTE8), //Hns Rematch   
    [REMATCH_TRAINER_SIDNEY] = REMATCH(TRAINER_SIDNEY, TRAINER_SIDNEY_2, TRAINER_SIDNEY_3, TRAINER_SIDNEY_4, TRAINER_SIDNEY_5, ROUTE9), //Hns Rematch
    [REMATCH_JASON] = REMATCH(TRAINER_JASON, TRAINER_JASON_2, TRAINER_JASON_3, TRAINER_JASON_4, TRAINER_JASON_5, ROUTE11), //Hns Rematch
    [REMATCH_JAKE] = REMATCH(TRAINER_JAKE, TRAINER_JAKE_2, TRAINER_JAKE_3, TRAINER_JAKE_4, TRAINER_JAKE_5, ROUTE26NORTH), //Hns Rematch
    [REMATCH_BRET] = REMATCH(TRAINER_BRET, TRAINER_BRET_2, TRAINER_BRET_3, TRAINER_BRET_4, TRAINER_BRET_5, ROUTE13), //Hns Rematch
    //Unused below
    ...
    //Special Rematches, unused aswell
...
u8 GetScaledLevel(u8 lvl)
{
    ...
    if (!FlagGet(FLAG_DEFEATED_RED))
    {
        ...
        {
            // If the player is Champion, has 8 or more badges,
            // but hasn't defeated Red, rematches will be limited to lvl 75.
            if ((FlagGet(FLAG_IS_CHAMPION)) && (lvl >= 75) && (badgeCount >= 8))
                lvl = 75;
            // If the player has 5 badges and the rematched Pokémon are level
            // higher than 36, set the ones higher than 36 to exactly 36.
        ...
        {
            // If the player is Champion, has 8 or more badges,
            // but hasn't defeated Red, rematches will be limited to lvl 70.
            if ((FlagGet(FLAG_IS_CHAMPION)) && (lvl >= 70) && (badgeCount >= 8))
                lvl = 70;
            // If the player has 5 badges and the rematched Pokémon are level
            // higher than 31, set the ones higher than 31 to exactly 31.
            else if ((lvl >= 31) && (badgeCount == 5))
                lvl = 31;
            // If the player has 6 badges and the rematched Pokémon are level
            // higher than 33, set the ones higher than 33 to exactly 33.
            else if ((lvl >= 33) && (badgeCount == 6))
                lvl = 33;
            // If the player has 7 badges and the rematched Pokémon are level
            // higher than 36, set the ones higher than 36 to exactly 36.
            else if ((lvl >= 36) && (badgeCount == 7))
                lvl = 36;
            // If the player has 8 badges and the rematched Pokémon are level
            // higher than 45, set the ones higher than 45 to exactly 45.
            else if ((lvl >= 45) && (badgeCount == 8))
                lvl = 45;
        }
        ...
        //easy mode rematch level cap, unchanged from Normal
        {
            // If the player is Champion, has 8 or more badges,
            // but hasn't defeated Red, rematches will be limited to lvl 70.
            if ((FlagGet(FLAG_IS_CHAMPION)) && (lvl >= 70) && (badgeCount >= 8))
