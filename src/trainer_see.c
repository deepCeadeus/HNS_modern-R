...
enum {
    ...
    TRSEE_OFFSCREEN_ABOVE_CREATE_CAMERA,
    TRSEE_OFFSCREEN_ABOVE_CAMERA_MOVE_UP,
    TRSEE_OFFSCREEN_ABOVE_CAMERA_MOVE_DOWN,
};
...
static bool8 (*const sTrainerSeeFuncList[])(u8 taskId, struct Task *task, struct ObjectEvent *trainerObj) =
{
    ...
    [TRSEE_OFFSCREEN_ABOVE_CREATE_CAMERA]   = TrainerSeeFunc_OffscreenAboveTrainerCreateCameraObj,
    [TRSEE_OFFSCREEN_ABOVE_CAMERA_MOVE_UP]   = TrainerSeeFunc_OffscreenAboveTrainerCameraObjMoveUp,
    [TRSEE_OFFSCREEN_ABOVE_CAMERA_MOVE_DOWN]   = TrainerSeeFunc_OffscreenAboveTrainerCameraObjMoveDown
};
...
{
    .tileTag = TAG_NONE,
    .paletteTag = 0x113D, //OBJ_EVENT_PAL_TAG_RED
    .oam = &sOamData_Icons,
...
static bool8 TrainerExclamationMark(u8 taskId, struct Task *task, struct ObjectEvent *trainerObj)
{
    ...
    {
        task->tFuncId = TRSEE_OFFSCREEN_ABOVE_CREATE_CAMERA;
    }
    else
    {
...
static bool8 TrainerSeeFunc_OffscreenAboveTrainerCameraObjMoveDown(u8 taskId, struct Task *task, struct ObjectEvent * trainerObj)
{
    ...
    {
        CameraObjectSetFollowedSpriteId(gPlayerAvatar.spriteId);
