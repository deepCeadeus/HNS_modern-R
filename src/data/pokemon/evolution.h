const struct Evolution gEvolutionTable[NUM_SPECIES][EVOS_PER_MON] =
{
    ...
    [SPECIES_STANTLER]  = {{EVO_MOVE, MOVE_BARRIER_RUSH, SPECIES_WYRDEER}},
    [SPECIES_URSARING]  = {{EVO_FRIENDSHIP_DAY, 0, SPECIES_URSALUNA},
                           {EVO_FRIENDSHIP_NIGHT, 0, SPECIES_URSALUNA_BLOODMOON}},
};
