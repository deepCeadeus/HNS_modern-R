...
static void Task_NewGameBirchSpeechSub_InitPokeBall(u8 taskId)
{
    ...
    CreatePokeballSpriteToReleaseMon(spriteId, gSprites[spriteId].oam.paletteNum, 112, 58, 0, 0, 32, PALETTES_BG, SPECIES_WOOPER, BALL_POKE);
...
{
    return CreateMonPicSprite_Affine(SPECIES_WOOPER, SHINY_ODDS << gSaveBlock1Ptr->tx_Features_ShinyChance, 0, MON_PIC_AFFINE_FRONT, x, y, 14, TAG_NONE);
}
