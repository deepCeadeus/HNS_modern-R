...
static const u8 sText_Description_Mode_Modern_Moves_On[]          = _("14 new MOVES, and improved MOVEPOOL\nfor all {PKMN} + new EGG and TUTOR MOVES.");
...
static const u8 sText_Description_Difficulty_HardExp_Enabled[]          = _("{PKMN} get 80% of EXP in HARD. Turns off\nafter beating the game. {COLOR 7}{COLOR 8}RECOMMENDED.");
