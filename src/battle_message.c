...
static const u8 sText_PlayerGotMoneyMom[] = _("{B_PLAYER_NAME} got ¥{B_BUFF1} for winning!\nYou sent some to Mom!\p");
...
static const u8 sText_PkmnRaisedAtk[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX}'s {B_SCR_ACTIVE_ABILITY}\nraised its Attack!");
...
static const u8 sText_PkmnPickedUpItemWith[] = _("{B_DEF_NAME_WITH_PREFIX} found a berry\nusing {B_DEF_ABILITY}!");
static const u8 sText_PkmnPickedUpGemWith[] = _("{B_DEF_NAME_WITH_PREFIX} found a gem\nusing {B_DEF_ABILITY}!");
...
const u8 * const gBattleStringsTable[BATTLESTRINGS_COUNT - BATTLESTRINGS_TABLE_START] =
{
    ...
    [STRINGID_PLAYERGOTMONEYMOM - BATTLESTRINGS_TABLE_START] = sText_PlayerGotMoneyMom,
    ...
    [STRINGID_PKMNRAISEDATK - BATTLESTRINGS_TABLE_START] = sText_PkmnRaisedAtk,
    ...
    [STRINGID_PKMNPICKEDUPITEMWITH - BATTLESTRINGS_TABLE_START] = sText_PkmnPickedUpItemWith,
    [STRINGID_PKMNPICKEDUPGEMWITH - BATTLESTRINGS_TABLE_START] = sText_PkmnPickedUpGemWith,
...
void BattlePutTextOnWindow(const u8 *text, u8 windowId)
{
    ...
    else
    {
        if (!(gSaveBlock2Ptr->optionsFontType))
            ...
            FillWindowPixelBuffer(windowId, textInfo_FRLG[windowId].fillValue);
        copyToVram = TRUE;
    }
