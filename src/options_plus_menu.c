...
{
    [MENUITEM_SOUND_SOUND]                           = {sText_Desc_SoundMono,              sText_Desc_SoundStereo,                 sText_Empty,                         sText_Empty,                       sText_Empty,                           sText_Empty,                       sText_Empty},
    [MENUITEM_SOUND_MUSIC]                           = {sText_Desc_Music_On,               sText_Desc_Music_Off,                   sText_Empty,                         sText_Empty,                       sText_Empty,                           sText_Empty,                       sText_Empty},
    [MENUITEM_SOUND_BIKE_MUSIC]                      = {sText_Desc_BikeMusicOn,            sText_Desc_BikeMusicOff,                sText_Empty,                         sText_Empty,                       sText_Empty,                           sText_Empty,                       sText_Empty},
    [MENUITEM_SOUND_SURF_MUSIC]                      = {sText_Desc_SurfMusicOn,            sText_Desc_SurfMusicOff,                sText_Empty,                         sText_Empty,                       sText_Empty,                           sText_Empty,                       sText_Empty},
    [MENUITEM_SOUND_WILD_MON_MUSIC]                  = {sText_Desc_WildMonMusic_Hoenn,     sText_Desc_WildMonMusic_Kanto_Old,      sText_Desc_WildMonMusic_Sinnoh,      sText_Desc_WildMonMusic_HGSS,      sText_Desc_WildMonMusic_BW,            sText_Desc_WildMonMusic_Random,    sText_Empty},
    [MENUITEM_SOUND_BATTLE_TRAINER_MUSIC]            = {sText_Desc_WildMonMusic_Hoenn,     sText_Desc_WildMonMusic_Kanto_Old,      sText_Desc_WildMonMusic_Sinnoh,      sText_Desc_WildMonMusic_HGSS,      sText_Desc_WildMonMusic_BW,            sText_Desc_WildMonMusic_Random,    sText_Empty},
    ...
    [MENUITEM_SOUND_EFFECTS]                         = {sText_Desc_SoundEffects_Gen3,      sText_Desc_SoundEffects_DP,             sText_Desc_SoundEffects_HGSS,        sText_Empty,                       sText_Empty,                           sText_Empty,                       sText_Empty},
};
...
static const u8 *const sText_Sound_WildMonBattleMusic_Strings_Seven[] = {sText_Sound_WildMon_Hoenn,  sText_Sound_WildMon_Kanto_Old,  sText_Sound_WildMon_Sinnoh,  sText_Sound_WildMon_Johto, sText_Sound_WildMon_Kanto_New, sText_Sound_WildMon_BW, sText_Sound_WildMon_Random};

static const u8 *const sText_Sound_WildMonBattleMusic_Strings[] = {sText_Sound_WildMon_Hoenn,  sText_Sound_WildMon_Kanto_Old,  sText_Sound_WildMon_Sinnoh,  sText_Sound_WildMon_HGSS, sText_Sound_WildMon_BW, sText_Sound_WildMon_Random};
static void DrawChoices_Wild_Battle_Music(int selection, int y)
{
    ...
    {
        gSaveBlock2Ptr->optionsWildBattleMusic = 4; // Unova
    }
    else
    {
...
static void DrawChoices_Trainer_Battle_Music(int selection, int y)
{
    ...
    {
        gSaveBlock2Ptr->optionsTrainerBattleMusic = 4; // Unova
    }
    else
    {
...
static void DrawChoices_Frontier_Trainer_Battle_Music(int selection, int y)
{
    ...
    DrawChoices_Options_Seven(sText_Sound_WildMonBattleMusic_Strings_Seven, selection, y, active);
