...
const u8 gText_ModernMessage[] = _("This is a modification of HEART & SOUL\ncreated by Resetes12.\pBug reports {COLOR RED}MUST NOT{COLOR DARK_GRAY} be sent\nto the original HEART & SOUL devs.\pReport issues at\n{COLOR BLUE}github.com/resetes12/HNS{UNDERSCORE}modern{COLOR DARK_GRAY}\pTo disable this message: enter OPTIONS,\nlook for 'SHOW INTRO MSG',\pthen set 'SHOW INTRO MSG' to OFF and\nsave your game.");
...
const u8 gText_KurtVar1AndYouWantedVar2Singular[] = _("And you wanted {STR_VAR_2}?\nThat will be {STR_VAR_3} BERRY.");
...
const u8 gText_CantUseUntilNewBadge_Fly[] = _("This can't be used until the CIANWOOD\nCITY BADGE is obtained.{PAUSE_UNTIL_PRESS}");
const u8 gText_CantUseUntilNewBadge_Flash[] = _("This can't be used until the VIOLET\nCITY BADGE is obtained.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_ExitMenu[] = _("EXIT MENU"); // Unused
...
const u8 gText_PokenavMap_CancelOnly[] = _("{B_BUTTON} Cancel");
