...
static const u16 gShadowVerticalOffsets[] = {
    4,
    4,
    4,
    16
...
static void UpdateStairsMovement(s16 a0, s16 a1, s16 *a2, s16 *a3, s16 *a4)
{
    ...
    playerSpr->subspriteMode = SUBSPRITES_IGNORE_PRIORITY;
    if (a1 > 0 || *a4 > 6)
        *a3 += a1;
...
static void HideFollowerForFieldEffect2(void) {
