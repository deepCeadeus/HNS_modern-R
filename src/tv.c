...
void ChangePokemonNickname(void)
{
    ...
    DoNamingScreen(NAMING_SCREEN_NICKNAME, gStringVar2, GetMonData(&gPlayerParty[gSpecialVar_0x8004], MON_DATA_SPECIES, NULL), GetMonGender(&gPlayerParty[gSpecialVar_0x8004]), GetMonData(&gPlayerParty[gSpecialVar_0x8004], MON_DATA_PERSONALITY, NULL), GetMonData(&gPlayerParty[gSpecialVar_0x8004], MON_DATA_OT_ID, NULL), ChangePokemonNickname_CB);
}
...
void ChangeBoxPokemonNickname(void)
{
    ...
    DoNamingScreen(NAMING_SCREEN_NICKNAME, gStringVar2, GetBoxMonData(boxMon, MON_DATA_SPECIES, NULL), GetBoxMonGender(boxMon), GetBoxMonData(boxMon, MON_DATA_PERSONALITY, NULL), GetBoxMonData(boxMon, MON_DATA_OT_ID, NULL), ChangeBoxPokemonNickname_CB);
}
